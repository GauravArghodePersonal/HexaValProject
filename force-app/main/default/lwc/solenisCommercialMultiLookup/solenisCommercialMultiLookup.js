...
export default class solenisCommercialMultiLookup extends LightningElement {
    @api label;
    @api required;
    @api placeholder = '';
    ...
    set selection(initialSelection) {
        ...
        //alert('Test'+JSON.stringify(this.curSelection));
    }
    get selection() {
        //alert(JSON.stringify(this.curSelection));
    ...
    setSearchResults(results) {
        ...
        this.searchResults = resultsLocal.map((result) => {
            ...
            if (typeof result.icon === 'undefined') {
                const { id, sObjectType, title } = result;
                return {
                    id,
                    sObjectType,
    ...
    @api
    getSelection() {
        //alert('6'+JSON.stringify(this.curSelection));
        return this.curSelection;
    }
    ...
    handleResultClick(event) {
        ...
        //alert('555'+JSON.stringify(this.curSelection));
        this.isDirty = true;
