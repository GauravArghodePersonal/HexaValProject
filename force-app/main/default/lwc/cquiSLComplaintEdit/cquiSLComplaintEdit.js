...
import cquiComplaintEdit from 'c/cquiComplaintEdit';
...
import FIELD_CQ_SL_RESPONSIBLE_PARTY__C from '@salesforce/schema/compliancequest__SQX_Complaint__c.CQ_SL_Responsible_Party__c';

import FIELD_CQ_SL_COMPLAINT_TYPE__C from '@salesforce/schema/compliancequest__SQX_Complaint__c.CQ_SL_Complaint_Type__c';

import FIELD_COMPLIANCEQUEST__ACTIVITY_COMMENT__C from '@salesforce/schema/compliancequest__SQX_Complaint__c.compliancequest__Activity_Comment__c';
...
import FIELD_CQ_SL_SQX_CUSTOMER_SAP_NAME__C from '@salesforce/schema/compliancequest__SQX_Complaint__c.CQ_SL_SQX_Customer_SAP_Name__c';
...
import FIELD_CQ_SL_SUBCATEGORY_DETAILS__C from '@salesforce/schema/compliancequest__SQX_Complaint__c.CQ_SL_Subcategory_Details__c';

import FIELD_CQ_SL_IS_THIS_A_REPEAT_INCIDENT__C from '@salesforce/schema/compliancequest__SQX_Complaint__c.CQ_SL_Is_this_a_Repeat_Incident__c';
...
import FIELD_CQ_SL_RESPONSIBLE_PARTY__NAME from '@salesforce/schema/compliancequest__SQX_Complaint__c.CQ_SL_Responsible_Party__r.Name';
...
import FIELD_CQ_SL_SQX_CUSTOMER_SAP_NAME__NAME from '@salesforce/schema/compliancequest__SQX_Complaint__c.CQ_SL_SQX_Customer_SAP_Name__r.Name';
...
import CQSL_COMPLAINT_CATEGORIZATION from '@salesforce/label/c.CQSL_COMPLAINT_CATEGORIZATION';
...
import CQSL_REPORTING_SITE from '@salesforce/label/c.CQSL_REPORTING_SITE';
...
const fields = [
    ...
    FIELD_CQ_SL_RESPONSIBLE_PARTY__C,
    
    FIELD_CQ_SL_COMPLAINT_TYPE__C,
    
    FIELD_COMPLIANCEQUEST__ACTIVITY_COMMENT__C,
    ...
    FIELD_CQ_SL_SQX_CUSTOMER_SAP_NAME__C,
    
    FIELD_CQ_SL_CUSTOMER_ADDRESS__C,
    
    FIELD_CQ_SL_SUBCATEGORY_DETAILS__C,
    
    FIELD_CQ_SL_IS_THIS_A_REPEAT_INCIDENT__C,
    ...
    FIELD_CQ_SL_RESPONSIBLE_PARTY__NAME,
    ...
    FIELD_CQ_SL_SQX_CUSTOMER_SAP_NAME__NAME,
...
const lookupDisplayFields = {
    ...
    "CQ_SL_Responsible_Party__c": FIELD_CQ_SL_RESPONSIBLE_PARTY__NAME,
    ...
    "CQ_SL_SQX_Customer_SAP_Name__c": FIELD_CQ_SL_SQX_CUSTOMER_SAP_NAME__NAME,
...
const FORM_RULES = {"CQ_SL_Supplier__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Supplier' "}},"CQ_SL_Supplier_Contact_Name__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Supplier' "}},"CQ_SL_Supplier_Phone__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Supplier' "}},"CQ_SL_Supplier_Fax__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Supplier' "}},"CQ_SL_Supplier_Email__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Supplier' "}},"CQ_SL_Carrier__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Carrier' "}},"CQ_SL_Carrier_Contact_Name__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Carrier' "}},"CQ_SL_Carrier_Email__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Carrier' "}},"CQ_SL_Pro__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Carrier' "}},"CQ_SL_Carrier_Fax__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Carrier' "}},"CQ_SL_Carrier_Phone__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Carrier' "}},"CQ_SL_Freight_Claim_Involved__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Carrier' "}},"CQ_SL_Shipment_Mode__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Carrier' "}},"CQ_SL_Customer_Region__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_SQX_Original_Sales_Order__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "},"invoke":{"fields":["CQ_SL_SQX_Original_Sales_Order__c"],"filter":"record.CQ_SL_SQX_Original_Sales_Order__c   ","action":[{"name":"CQ_SL_Complaint_Set_Sales_Orders_AL_Flow","ns":""}]},"setValues":[{"fields":["CQ_SL_SQX_Original_Sales_Order__c"],"filter":"!record.CQ_SL_SQX_Original_Sales_Order__c   ","action":{"CQ_SL_Part_Name_Text__c":null,"compliancequest__Country_of_Origin__c":null,"CQ_SL_SQX_Sales_Order_Deliveries__c":null}}]},"CQ_SL_Outside_Involvement__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Customer_Group_Description__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Customer_Address__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_SQX_Responder__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Base_Code__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Material__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Base_Code_Desc__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Sub_Segment__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Line_of_Business__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Sales_Business_Unit__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_CSR__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Material_Description__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Received_Quantity__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Segment__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Customer_Group__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Sales_Rep__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"compliancequest__SQX_Account__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Lot__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Requested_Quantity__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Shipped_Quantity__c":{"visible":{"fields":["CQ_SL_Complaint_Type__c"],"filter":"record.CQ_SL_Complaint_Type__c == 'Customer Complaint (no external involvement)'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Supplier Involvement'  || record.CQ_SL_Complaint_Type__c == 'Customer Complaint w/ Carrier Involvement' "}},"CQ_SL_Supplier_ID__c":{"visible":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Supplier' "}},"CQ_SL_SQX_Supplier_SAP_ID__c":{"hidden":{"fields":["CQ_SL_Outside_Involvement__c"],"filter":"record.CQ_SL_Outside_Involvement__c == 'Carrier'  || !record.CQ_SL_Outside_Involvement__c   "}}};
const FORMULA_FIELDS = {};

export default class cquiSLComplaintEdit  extends cquiComplaintEdit {
    ...
    constructor() {
        ...
        this.sectionHider = {"expando_unique_id_1":true,"expando_unique_id_2":true,"expando_unique_id_3":true,"expando_unique_id_4":true,"expando_unique_id_5":true,"expando_unique_id_6":true,"expando_unique_id_7":true,"expando_unique_id_8":true,"expando_unique_id_9":true,"expando_unique_id_10":true,"expando_unique_id_11":true}
    ...
    get v_CQ_SL_RESPONSIBLE_PARTY__C() {
        return this.getValueFor(FIELD_CQ_SL_RESPONSIBLE_PARTY__C.fieldApiName);
    }
    get f_CQ_SL_RESPONSIBLE_PARTY__C() {
        let val=this.fieldsInfo ? this.fieldsInfo[FIELD_CQ_SL_RESPONSIBLE_PARTY__C.fieldApiName] : {};
        return val;
    }

    get d_CQ_SL_RESPONSIBLE_PARTY__C() {
        return lookupDisplayFields[FIELD_CQ_SL_RESPONSIBLE_PARTY__C.fieldApiName] && this.getValueFor(lookupDisplayFields[FIELD_CQ_SL_RESPONSIBLE_PARTY__C.fieldApiName].fieldApiName);
    }
    ...
    get v_COMPLIANCEQUEST__ACTIVITY_COMMENT__C() {
        return this.getValueFor(FIELD_COMPLIANCEQUEST__ACTIVITY_COMMENT__C.fieldApiName);
    }
    get f_COMPLIANCEQUEST__ACTIVITY_COMMENT__C() {
        let val=this.fieldsInfo ? this.fieldsInfo[FIELD_COMPLIANCEQUEST__ACTIVITY_COMMENT__C.fieldApiName] : {};
        return val;
    }

    get d_COMPLIANCEQUEST__ACTIVITY_COMMENT__C() {
        return lookupDisplayFields[FIELD_COMPLIANCEQUEST__ACTIVITY_COMMENT__C.fieldApiName] && this.getValueFor(lookupDisplayFields[FIELD_COMPLIANCEQUEST__ACTIVITY_COMMENT__C.fieldApiName].fieldApiName);
    }
    ...
    get v_CQ_SL_SQX_CUSTOMER_SAP_NAME__C() {
        return this.getValueFor(FIELD_CQ_SL_SQX_CUSTOMER_SAP_NAME__C.fieldApiName);
    }
    get f_CQ_SL_SQX_CUSTOMER_SAP_NAME__C() {
        let val=this.fieldsInfo ? this.fieldsInfo[FIELD_CQ_SL_SQX_CUSTOMER_SAP_NAME__C.fieldApiName] : {};
        return val;
    }

    get d_CQ_SL_SQX_CUSTOMER_SAP_NAME__C() {
        return lookupDisplayFields[FIELD_CQ_SL_SQX_CUSTOMER_SAP_NAME__C.fieldApiName] && this.getValueFor(lookupDisplayFields[FIELD_CQ_SL_SQX_CUSTOMER_SAP_NAME__C.fieldApiName].fieldApiName);
    }
    ...
    get v_CQ_SL_SUBCATEGORY_DETAILS__C() {
        return this.getValueFor(FIELD_CQ_SL_SUBCATEGORY_DETAILS__C.fieldApiName);
    }
    get f_CQ_SL_SUBCATEGORY_DETAILS__C() {
        let val=this.fieldsInfo ? this.fieldsInfo[FIELD_CQ_SL_SUBCATEGORY_DETAILS__C.fieldApiName] : {};
        return val;
    }

    get d_CQ_SL_SUBCATEGORY_DETAILS__C() {
        return lookupDisplayFields[FIELD_CQ_SL_SUBCATEGORY_DETAILS__C.fieldApiName] && this.getValueFor(lookupDisplayFields[FIELD_CQ_SL_SUBCATEGORY_DETAILS__C.fieldApiName].fieldApiName);
    }

    
    get v_CQ_SL_IS_THIS_A_REPEAT_INCIDENT__C() {
        return this.getValueFor(FIELD_CQ_SL_IS_THIS_A_REPEAT_INCIDENT__C.fieldApiName);
    }
    get f_CQ_SL_IS_THIS_A_REPEAT_INCIDENT__C() {
        let val=this.fieldsInfo ? this.fieldsInfo[FIELD_CQ_SL_IS_THIS_A_REPEAT_INCIDENT__C.fieldApiName] : {};
        return val;
    }

    get d_CQ_SL_IS_THIS_A_REPEAT_INCIDENT__C() {
        return lookupDisplayFields[FIELD_CQ_SL_IS_THIS_A_REPEAT_INCIDENT__C.fieldApiName] && this.getValueFor(lookupDisplayFields[FIELD_CQ_SL_IS_THIS_A_REPEAT_INCIDENT__C.fieldApiName].fieldApiName);
    }
    ...
    get CQSL_COMPLAINT_CATEGORIZATION() {
        return CQSL_COMPLAINT_CATEGORIZATION;
    }
    ...
    get CQSL_REPORTING_SITE() {
        return CQSL_REPORTING_SITE;
    }
