...
import fetchRecords from '@salesforce/apex/ForcastProReusableLookupController.fetchRecords';
/** The delay used when debouncing event handlers before invoking Apex. */
const DELAY = 500;

export default class forecastProReusableLookup extends LightningElement {
    ...
    handleSelect(event) {
        let selectedRecord = {
            ...
            key: event.currentTarget.dataset.uniquekey
        };
    ...
    @api validateField(event) {
        let element = this.template.querySelector(".validate");
