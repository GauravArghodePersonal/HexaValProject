...
import DCFROR_OBJECT from '@salesforce/schema/CAPEX__c';
 ...
 */
export default class SolenisCAPEXDCFROR extends NavigationMixin(LightningElement) {
    @api recordId;
    @track isModalDCFROR;
    @track  statictest=0;
...
@track productId;
    ...
    //myFields = [NAME_FIELD, DCFROR__c,CAPEX_Amount__c,Comment__c];
    isModalDCFROR=false;
    ...
    handleReset(event) {
        this.isLoading=true;
        this.productId = null;
        console.log('Inside reset'+this.recordId);
        ...
        console.log('2Inside reset'+this.recordId);
        this.template.querySelector('.DCFROR__c').value=this.recordId;
        console.log('Value Set reset'+this.recordId);
        this.isLoading=false;
     }
