...
export default class LWR_EMEAPALRequestForm extends NavigationMixin(LightningElement) {
    recordId;
    objectName;
    sitRecordId;
    header = '';
    ...
    /*handleCancel() {
        if(this.sitRecordId){
            console.log("Record Id is sitRecordId"+this.sitRecordId);
            this.dispatchEvent(new CloseActionScreenEvent());
